...
## Improvements: Adding layers to the network to create a more complex model.
...
#            idx = -1
            ...
            #state2, action_t2, reward_t2, state_tp12 = self.memory[idx][0]
    ...
    def load(self):
        self.memory = pickle.load(open("BinhMinhmemory.pkl","rb"))
    
    def save(self):
        pickle.dump(self.memory,open("BinhMinhmemory.pkl","wb"))